...
<script src="ajax/informe_compra_finalizado.js"></script>
<div class="col-md-8 offset-md-2 d-flex justify-content-center align-items-center vh-90">
    <div class="container">
        <div class="card border-primary shadow-lg">
            <div class="card-body">
                <h4 class="text-primary text-center">Informe  de Compras Finalizadas</h4>
                <form action="#" id="form" enctype="multipart/form-data" method="POST" role="form"  class="form-horizontal form-groups-bordered">
                    <div class="form-group">
                        <input class=" form-control" type="hidden" name="idcompras" id="idcompras" placeholder=" Codigo " readonly>
                        <input class=" form-control" type="hidden" name="iddetallcompras" id="iddetallcompras" placeholder=" Codigo " readonly>
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-secondary text-white">
                <h4 class="modal-title text-white">Registro de Compras Finalizadas</h4>
