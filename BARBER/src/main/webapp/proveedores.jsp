...
<div class="container-fluid mt-4">
    <div class="row">
        <div class="md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title mb-3">Formulario Proveedor</h5>
                    <form id="form">
        ...
        <div class="col-md-8">
            <h1>Listado de Proveedores <button class="btn btn-outline-secondary" data-ciudades="1" title="Imprimir" data-toggle="modal" data-target="#Imprimirl">
    Imprimir Listado General <img src="img/impresora (1).png" title="Imprimir">
            ...
            <table class="table table-striped" id="resultado">
                ...
                <tbody>
                    <!-- Aquí se deben cargar los datos de los proveedores desde la base de datos -->
                </tbody>
            </table>
        </div>
    </div>
