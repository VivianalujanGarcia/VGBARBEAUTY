$(document).ready(function () {
    ...
    $("#buscar").on('click', function (e) {
        ...
        var listar = (id_proveedor && id_proveedor !== "") ? 'listarcompra_proveedor' : 'listarcompra';
        ...
        $.ajax({
            ...
            url: 'jsp/informe_compra_proveedor.jsp', // Ruta del JSP que procesará la solicitud
            type: 'post',
    ...
    $("#imprimi").on('click', function () {
        ...
        window.open('jsp/informe_compras_proveedor.jsp?fecha_desde=' + encodeURIComponent(fecha_desde) +
