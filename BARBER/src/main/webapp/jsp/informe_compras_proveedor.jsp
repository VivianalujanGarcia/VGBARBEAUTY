...
<%
    try {
        ...
        File reportFile = new File(application.getRealPath("reportes/compras_informe_proveedor.jasper"));
        ...
        String id_proveedorStr = request.getParameter("id_proveedor");
        ...
        if (id_proveedorStr != null && !id_proveedorStr.isEmpty()) {
            parametros.put("id_proveedor", Integer.parseInt(id_proveedorStr));
        }
