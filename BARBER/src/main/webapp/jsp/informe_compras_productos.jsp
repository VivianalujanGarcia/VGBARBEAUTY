...
<%
    try {
        ...
        File reportFile = new File(application.getRealPath("reportes/compras_informe_productos.jasper"));
        ...
        String id_productoStr = request.getParameter("id_producto");
        ...
        if (id_productoStr != null && !id_productoStr.isEmpty()) {
            parametros.put("id_producto", Integer.parseInt(id_productoStr));
        }
