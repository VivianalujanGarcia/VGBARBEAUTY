...
<script src="ajax/informe_venta_anulada.js"></script>
<div class="col-md-8 offset-md-2 d-flex justify-content-center align-items-center vh-90">
    <div class="container">
        <div class="card border-primary shadow-lg">
            <div class="card-body">
                <h4 class="text-primary text-center">Informe  de Ventas Anuladas</h4>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-secondary text-white">
                <h4 class="modal-title text-white">Registro de Ventas Anuladas</h4>
