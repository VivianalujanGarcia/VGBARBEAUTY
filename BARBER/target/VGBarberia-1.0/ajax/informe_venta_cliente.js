$(document).ready(function () {
    ...
    $("#buscar").on('click', function (e) {
        ...
        var listar = (id_cliente && id_cliente !== "") ? 'listarventa_cliente' : 'listarventa';
        ...
        $.ajax({
            ...
            url: 'jsp/informe_venta_cliente.jsp', // Ruta del JSP que procesará la solicitud
            type: 'post',
    ...
    $("#imprimi").on('click', function () {
        ...
        window.open('jsp/informe_ventas_clientes.jsp?fecha_desde=' + encodeURIComponent(fecha_desde) +
