$(document).ready(function () {
    ...
    $("#buscar").on('click', function (e) {
        ...
        var listar = (id_producto && id_producto !== "") ? 'listarventa_producto' : 'listarventa';
        ...
        $.ajax({
            ...
            url: 'jsp/informe_detalle_producto.jsp', // Ruta del JSP que procesará la solicitud
            type: 'post',
    ...
    $("#imprimi").on('click', function () {
        ...
        window.open('jsp/informe_ventas_productos.jsp?fecha_desde=' + encodeURIComponent(fecha_desde) +
