    ...
    if ((fechaDesde == null || fechaDesde.isEmpty()) || (fechaHasta == null || fechaHasta.isEmpty())) {
        ...
        if (request.getParameter("listar") != null && request.getParameter("listar").equals("listarcompra")) {
            try {
                ...
                String query = "SELECT to_char(v.fecha, 'dd-mm-yyyy') AS fecha_formateada, a.nombre, a.ruc, v.total, v.id FROM compras v JOIN proveedores a ON v.id_proveedor = a.id_proveedor WHERE v.estado ='Finalizado' AND v.fecha BETWEEN '" + fechaDesde + "' AND '" + fechaHasta + "'";
