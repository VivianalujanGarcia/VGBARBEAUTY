...
<script src="ajax/marca.js"></script>
<style>
        body {
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form id="form">
                    <h5 class="card-title mb-0">Formulario Marca</h5>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <h1>Listado de Marcas <button class="btn btn-outline-secondary" data-ciudades="1" title="Imprimir" data-toggle="modal" data-target="#Imprimirl">
