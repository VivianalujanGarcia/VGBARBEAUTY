...
<script src="ajax/informe_detalle_productopago.js"></script>
            ...
            <div class="card-body">
                ...
                <form action="#" id="form" enctype="multipart/form-data" method="POST" role="form"  class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="id_cliente" class="form-label">Proveedor:</label>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-secondary text-white">
                <h4 class="modal-title text-white">Registro de Cobros</h4>
