    ...
    <body>
        <div class="container">
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong> No se puede ingresar a PAGOS porque no hay una caja abierta.</strong>
            </div>
        </div>
        <script>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" onclick="location.href = 'detpagos.jsp'" class="btn btn-primary">Nuevo pago</button>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                        <button class="btn btn-outline-secondary" data-ciudades="1" title="Imprimir" onclick="window.open('jsp/ListadoPagos.jsp', '_blank')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Anular Pag</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="eliminar-registro-pago">SI</button>
            </div>
        </div>
    </div>
</div>
